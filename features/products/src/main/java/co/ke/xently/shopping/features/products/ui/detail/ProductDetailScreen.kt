...
internal object ProductDetailScreen {
    private const val TAG_DATE_OF_PURCHASE_PICKER = "TAG_DATE_OF_PURCHASE_PICKER"
    ...
    operator fun invoke(
        ...
        val shopSuggestions =
            shopPaginatedSearchViewModel.searchAutoComplete.collectAsLazyPagingItems()
    ...
    operator fun invoke(
        ...
        shopSuggestions: LazyPagingItems<Shop>,
